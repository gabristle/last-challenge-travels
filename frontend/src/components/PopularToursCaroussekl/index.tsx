                ...
                {tours?.map((tour: Tour, index) => {
                    return (
                        <li key={index} className='splide__slide'>
                            <TourCard image={cologne} city={tour.city} country={tour.country} tour={tour.name} grade={tour.averageGrade} reviews={tour.reviewCount} duration={tour.duration} cost={tour.costPerPerson}></TourCard>
                        </li>
                    )
                })}
            </ul>
